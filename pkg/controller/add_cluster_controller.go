...
//+kubebuilder:rbac:groups=packet.cluster.k8s.io,resources=packetclusterproviderspecs;packetclusterproviderstatuses,verbs=get;list;watch;create;update;patch;delete
func init() {
