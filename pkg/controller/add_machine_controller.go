...
//+kubebuilder:rbac:groups=packet.cluster.k8s.io,resources=packetmachineproviderspecs;packetmachineproviderstatuses,verbs=get;list;watch;create;update;patch;delete
func init() {
